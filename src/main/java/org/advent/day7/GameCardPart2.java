...
public class GameCardPart2 implements Comparable<GameCardPart2>{
    public static final char[] LABELS = {'A', 'K', 'Q', 'J', 'T', '9', '8', '7', '6', '5', '4', '3', '2', 'J'};
    ...
    public GameCardPart2(String labels, long bid) {
    ...
    @Override
    public int compareTo(GameCardPart2 o) {
